...
APPNAME=mtb-example-psoc4-safety-uart-loopback-test
...
CY_IGNORE+=$(wildcard $(SEARCH_mtb-stl)/*Clock.*) $(wildcard $(SEARCH_mtb-stl)/*Interrupt.*) $(wildcard $(SEARCH_mtb-stl)/*UART_Debug.*)
